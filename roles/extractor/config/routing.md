...
|-------|------|---------|------|
| _Твой домен (напр. Machine Learning)_ | _PACK-my-domain_ | _MD_ | _/home/evgeny/Github/PACK-my-domain/pack/my-domain/_ |
...
| Правило (глобальное) | `rule` | `/home/evgeny/Github/CLAUDE.md` | Строки |
...
|---------|--------|-------------|
| _Мой бот_ | _your-org/my-bot_ | _/home/evgeny/Github/your-org/my-bot/docs/_ |
